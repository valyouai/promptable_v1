...
const CREATOR_TEMPLATES: Record<ContentType, PromptTemplate> = {
    "visual-content-analysis": {
...
} as Record<ContentType, PromptTemplate>;

const EDUCATOR_TEMPLATES: Record<ContentType, PromptTemplate> = {
    "learning-theory-implementer": {
...
const RESEARCHER_TEMPLATES: Record<ContentType, PromptTemplate> = {
    "methodology-replicator": {
...
const PERSONA_TEMPLATES: Record<Persona, Record<ContentType, PromptTemplate>> = {
    creator: CREATOR_TEMPLATES as Record<ContentType, PromptTemplate>,
    educator: EDUCATOR_TEMPLATES as Record<ContentType, PromptTemplate>,
    researcher: RESEARCHER_TEMPLATES as Record<ContentType, PromptTemplate>
};

export function generateSystemPrompt(
    transformedConcepts: TransformedConcepts,
    persona: Persona,
    contentType: ContentType,
    config: GenerationConfig
): string {
    console.log('[generateSystemPrompt] Received transformedConcepts:', JSON.stringify(transformedConcepts, null, 2));
    console.log(`[generateSystemPrompt] Persona: ${persona}, ContentType: ${contentType}, Config: ${JSON.stringify(config, null, 2)}`);
