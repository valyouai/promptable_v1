...
export function buildSystemPrompt(params: {
    ...
    // This is a placeholder, you'll want to use the extractedConcepts, persona,
    ...
    prompt += `Principles: ${extractedConcepts.principles?.join(', ') || 'N/A'}\n`;
    prompt += `Methods: ${extractedConcepts.methods?.join(', ') || 'N/A'}\n`;
    prompt += `Frameworks: ${extractedConcepts.frameworks?.join(', ') || 'N/A'}\n`;
    prompt += `Theories: ${extractedConcepts.theories?.join(', ') || 'N/A'}\n`;
    if (extractedConcepts.notes) {
        prompt += `Notes: ${extractedConcepts.notes}\n`;
    }
