...
interface AnalysisPreviewProps {
  ...
  // onConceptSelect: (concepts: string[]) => void; // Removed as it's not used in MVP
}
    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div>
        ...
        {principles.length > 0 ? (
          ...
          <p className="text-gray-500">No principles extracted.</p>
        )}
        ...
        {methods.length > 0 ? (
          ...
          <p className="text-gray-500">No methods extracted.</p>
        )}
        ...
        {frameworks.length > 0 ? (
          ...
          <p className="text-gray-500">No frameworks extracted.</p>
        )}
        ...
        {theories.length > 0 ? (
          ...
          <p className="text-gray-500">No theories extracted.</p>
        )}
      </div>
